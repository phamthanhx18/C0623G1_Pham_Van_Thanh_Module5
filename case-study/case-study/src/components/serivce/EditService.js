            ...
            <div className="row my-5">
                ...
                <form>
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="nameService"
                                   defaultValue="Room View Biển 201"/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label htmlFor="areaUse" className="col-sm-2 col-form-label">Diện tích sử dụng</label>
                        <div className="col-sm-10">
                            <input type="number" className="form-control" id="areaUse" defaultValue={50}/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label htmlFor="rentalPrice" className="col-sm-2 col-form-label">Chi phí thuê (USD)</label>
                        <div className="col-sm-10">
                            <input type="number" className="form-control" id="rentalPrice" defaultValue={500}/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label htmlFor="maxPeople" className="col-sm-2 col-form-label">Số lượng người tối đa</label>
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="maxPeople" defaultValue={2}/>
                        </div>
                    </div>
                    <div className="row mb-3">
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-10">
                            <textarea className="form-control" id="standards" rows={5}
                                      defaultValue={"Được trang trí với tông màu dịu nhẹ kết hợp với những đồ thủ công trang trí mang đậm hơi thở văn hóa Chăm-pa của địa phương, căn phòng được chia tầng rõ rệt. Ở dưới là khu vực sinh hoạt với ghế sofa chữ L và ở trên là giường ngủ tạo cảm giác trang nhã mà rất thân thuộc như ở nhà.\n                    "}/>
                        </div>
                    </div>
                    <div className="row mb-3">
                    ...
                    <fieldset className="row mb-3">
                        ...
                        <div className="col-sm-10">
                            <div className="form-check">
                                <input className="form-check-input" type="checkbox" id="gridCheck1" defaultChecked/>
